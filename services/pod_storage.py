...
def store_pod_bytes(filename, file_bytes, content_type=None, bucket_name=None, instance_path=None):
    ...
    upload_folder = os.path.join((instance_path or current_app.instance_path), "uploads")
