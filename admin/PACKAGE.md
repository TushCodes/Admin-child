...
The standalone admin app listens on port `5001` by default, redirects `/` to `/admin/dashboard`, and exposes `/admin/login`, `/admin/dashboard`, `/flask-admin/`, `/admin/api/...`, `/health`, and `/health/db`.
